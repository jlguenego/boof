	...
	app.directive('jlgTypeahead', ['$injector', function($injector) {
		...
		return {
			...
			link: function(scope, element, attrs, ctrl) {
				...
				var tag = angular.element('<div ng-hide="isInputVisible" class="jlg-typeahead-tag"><span>{{value}}<span class="remove" ng-click="remove()">x</span></span></div>');
				element.append(tag);
				$compile(tag)(scope);
				...
				var template = (attrs.template) ? attrs.template : 'jlg-typeahead/tmpl/popup-item.html';
